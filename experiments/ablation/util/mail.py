...
""""
Adaption of Zapier Email Reply Parser to recognize German message headers
Original source: https://github.com/zapier/email-reply-parser
License: MIT 
"""
...
class EmailMessage(object):
    ...
    HEADER_REGEX = re.compile(r'^\*?(From|Sent|To|Subject|Von|An|Betreff|Gesendet):\*? .+')
